(function($) {
	...
	if (typeof ServiceCue!=='undefined') {
		$.extend(ServiceCueOptions, ServiceCue);
	}
	...
	$.ServiceCueTheme = {
		...
		mapCreate:function() {
			...
			if (ServiceCueOptions.zoomControlDiv===null) {				
				var zoomControlDiv = document.createElement('div');		
				var zoomControl = new customZoomControl(zoomControlDiv, map);
				ServiceCueOptions.zoomControlDiv = zoomControlDiv;
			}

			//Insert the zoom div on the top left of the map
			map.controls[google.maps.ControlPosition.LEFT_TOP].push(ServiceCueOptions.zoomControlDiv);
		},
...
function shareTo(network, title, image, url) {
	return $.ServiceCueTheme.share(network, title, image, url);
}
