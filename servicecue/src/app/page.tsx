          ...
          <div className="row">
            <div className="col-12 col-md-12 col-lg-12">
              <div className="text-center" >
                <a href="https://links.servicecue.com/widget/booking/qubwm8AJ5MfgZ6D037Vr" className="btn mb-3">BOOK A LIVE DEMO</a> 
                <a href="https://servicecue.com.au/register" className="btn mb-3">IM READY, SIGN ME UP</a>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="row align-items-center pricing-plans">
            <div className="col-12 col-lg-4 res-margin">
              <div className="price-table">
                ...
                <ul className="overview-list overview-list-gs">
                  ...
                  <li>
                    <p><i className="fa-li fas fa-check"></i>Up to 150 clients</p>
                  </li>
                  <li>
              ...
              <div className="price-table plan-popular mb-4 mb-sm-5 mb-lg-0 ">
                ...
                <div className="gs-padding12">
                  ...
                  <ul className="overview-list overview-list-gs">
                    ...
                    <li>
                      <p><i className="fa-li fas fa-check"></i>Unlimited product/service listings</p>
                    </li>
                    <li>
            ...
            <div className="col-12 col-lg-4">
              <div className="price-table">
                ...
                <ul className="overview-list overview-list-gs">
                  <li>
                    <p><i className="fa-li fas fa-check"></i>Up to 12 staff members</p>
                  </li>
                  <li>
                    <p><i className="fa-li fas fa-check"></i>Unlimited clients</p>
                  </li>
                  ...
                  <li>
                   ...
                   <li>
                    <p><i className="fa-li fas fa-check"></i>Single site Location only</p>
                  </li>
                  <li>
                    <p><i className="fa-li fas fa-check"></i>Free client app and client access</p>
                  </li>
