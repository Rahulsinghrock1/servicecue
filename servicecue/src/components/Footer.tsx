            ...
            <div className="col-12 col-md-6 col-lg-12">
              <div className="widget text-center">
                ...
                <div className="mb-5 mt-4 d-block button-store" style={{textDecoration:"none !important"}}> 
                  <a href="https://play.google.com/store/apps/details?id=com.servicecue.user" className="custom-btn d-inline-flex align-items-center m-2 m-sm-0 mb-sm-3" style={{textDecoration:"none !important"}}><i className="fab fa-google-play"></i>
                  <p>Available on<span>Google Play</span></p>
                  </a> <a href="https://apps.apple.com/in/app/service-cue/id6754311490" className="custom-btn d-inline-flex align-items-center m-2 m-sm-0" style={{textDecoration:"none !important"}}><i className="fab fa-apple"></i>
