...
const { SplashScreens,Category,ProductCategory,sendEnquiry,clinicProfessionals,myEnquiry,faqs,getPage,Users,deleteUser,toggleUserStatus,Pages,updatePage,forgotPassword,CategoryServices,CategoryTreatment,editProductPrescriptionsoptions,ProductType,ProductDose,dashboardData,admindashboardData,lastactivetreatment,support,notifications } = require('@controllers/Common/commonController');
const { sendOtp,Logout,verifyOtp,register,clinicRegister,profileDetails,login,skiplogin,editProfile,changePassword,clinicchangePassword  } = require('@controllers/app/auth/authController');
...
const { createOrUpdateProduct,getProducts,deleteProduct,ProductsDetails,deleteProductImage,ProductPrescriptions,treatmentProducts} = require('@controllers/api/ClinicController');
...
router.delete('/deleteProductImage/:id', authMiddleware, deleteProductImage);
