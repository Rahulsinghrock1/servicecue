...
exports.AssignedClients = async (req, res) => {
  try {
    ...
    await AssignClient.bulkCreate(newAssignments);
      ...
      console.log("✅ Firebase notification sent successfully",staff_details.push_token);
const message = {
      ...
      await transporter.sendMail({
        ...
        html: `
          <div style="font-family: 'Segoe UI', Roboto, sans-serif; max-width: 600px; margin: auto; border: 1px solid #e0e0e0; border-radius: 8px; padding: 30px; background-color: #ffffff;">
            ...
            <p style="font-size: 16px; color: #333;">
              🔐 <em>For security, please change your password after your first login.</em>
            </p>

            <p style="font-size: 16px; color: #333;">
              🌐 You will be able to access the platform via the official login page. We’ll share the login link soon once the app is live.
            </p>

            <p style="font-size: 16px; color: #333;">Welcome aboard! If you have any questions, just reply to this email—we’re happy to assist.</p>

            <p style="font-size: 16px; color: #333;">Warm regards,<br/><strong>The ServiceCue Team</strong></p>

            <hr style="margin: 40px 0; border: none; border-top: 1px solid #e0e0e0;" />

            <p style="font-size: 12px; color: #999; text-align: center;">
              This email was intended for ${email}. If you did not expect this email, please ignore it.
            </p>
          </div>
        `,
      });
