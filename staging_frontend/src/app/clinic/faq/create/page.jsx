...
const SiteCreate = () => {
    ...
    const [previewImage, setPreviewImage] = useState("/assets/admin/img/building.png");
    const [selectedDate, setSelectedDate] = useState(null);
    const [redirectToQuote, setRedirectToQuote] = useState(false);
    ...
    const handleAddCategory = async () => {
        ...
        try {
            ...
            // Re-fetch categories
            const refreshed = await axios.get(`${API_BASE_URL}/category-list`);
            setCategories(Array.isArray(refreshed.data.data) ? refreshed.data.data : []);
        } catch (error) {
            handleErrorResponse(error);
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const accessToken = localStorage.getItem("curtishCleanAuthToken");
            const response = await axios.post(`${API_BASE_URL}/site-store`, formData, {
                headers: {
            ...
            const siteId = response.data.data.id;
            if (redirectToQuote) {
                router.push(`/admin/site/${siteId}/quote/add`);
            } else {
                        ...
                        <div className="card-body">
                            <form onSubmit={handleSubmit} encType="multipart/form-data">
                                <div className="row mb-2">
                                    ...
                                    <div className="col-md-3">
                                        <div className="form-group">
                                            <label htmlFor="category_id" className="d-flex justify-content-between align-items-center">
                                              Category
                                              <span
                                    ...
                                    <div className="col-md-3">
                                        <div className="form-group">
                                            ...
                                            <DatePicker
                                                ...
                                                selected={siteData.service_start_date ? new Date(siteData.service_start_date) : null}
                                ...
                                {/* Submit Button */}
                                <div className="mt-3">
                                    {/* <button type="submit" className="btn btn-dark me-2" disabled={loading} onClick={() => setRedirectToQuote(false)}> */}
                                    {/*     {loading ? "Creating..." : "Submit"} */}
                                    {/* </button> */}

                                    <button type="submit" className="btn btn-primary" disabled={loading} onClick={() => setRedirectToQuote(true)}>
                                        {loading ? "Creating..." : "Submit & Create Quote"}
                                    </button>
                                </div>
                            </form>
                        </div>
                ...
                <div className="modal-dialog" role="document">
                  <div className="modal-content">
                    <div className="modal-header">
                      ...
                      <button type="button" className="close btn btn-default" onClick={() => setShowAddCategoryModal(false)}>
                        <span>&times;</span>
                      </button>
                    </div>
