                  ...
                  assignedClients.map(({ id, created_at, notes, client }) => (
                    <tr key={id}>
                      <td>
                        <div className="d-flex align-items-center">
                          <a href="#" className="avatar me-2">
                            <img
                              src={client.avatar || "/assets/img/users/user-39.jpg"}
                      ...
                      <td>
                       ...
                       <td>+61 14554 54584  </td>
                        <td><a href="javascript:void(0);" className="text-success">Body Detox Wraps</a></td>
                         <td>{notes || "-"}</td>
                      <td><span class="text-success">Active</span></td>
                      <td>{/* Actions if needed */}</td>
                    </tr>
                  ))
                ) : (
                  <tr>
          ...
          <div className="card">
            <div className="card-body">
              ...
              {[
                ...
                { icon: "ti-blood", label: "Blood Group", value: bloodGroup },
                { icon: "ti-award", label: "Experience", value: expertise },
