  ...
  useEffect(() => {
    ...
    const fetchStaffDetails = async (sId) => {
      ...
      try {
        ...
        setFormData((prev) => ({
          ...prev,
          full_name: data.full_name ?? data.full_name ?? data.full_name ?? prev.full_name,
        ...
        <div className="card-body">
          ...
          <div className="row">
            ...
            <div className="col-lg-6 mb-3">
              ...
              <input type="date" name="dob" className="form-control" value={formData.dob} onChange={handleChange} max={new Date().toISOString().split("T")[0]} />
            </div>
            ...
            <div className="col-lg-12 mb-3">
              ...
              <textarea className="form-control" name="about" rows="4" placeholder="About Staff" value={formData.about} onChange={handleChange}></textarea>
            </div>
          </div>
