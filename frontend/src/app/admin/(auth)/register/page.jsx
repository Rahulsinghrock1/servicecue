...
export default function RegisterPage() {
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      if (result.user_role_id == 3 || result.user_role_id == 4) {
        router.push("/clinic");
      } else {
        router.push("/login");
      }
                      ...
                      <div className="card border-1 p-lg-3 shadow-md rounded-3 m-0">
                        <div className="card-body">
                          <div className="text-center mb-3">
                            <h5 className="mb-1 fs-20 fw-bold">Register Your Clinic</h5>
                            <p className="mb-0">Please enter your details to create account</p>
                          </div>
                            ...
                            <div className="position-relative">
                              <div className="pass-group input-group position-relative border rounded">
                                ...
                                <span
                                  ...
                                  style={{ cursor: "pointer" }}
                                >
                                  <i className={`ti toggle-password ${showConfirmPassword ? "ti-eye" : "ti-eye-off"} text-dark fs-18`}></i>
                                </span>
                              </div>
                            </div>
                          </div>
                          ...
                          <div className="d-flex align-items-center justify-content-between mb-3">
                            <div className="form-check form-check-md mb-0">
                              <input className="form-check-input" id="terms" name="terms_accepted" type="checkbox" required />
                              <label htmlFor="terms" className="form-check-label mt-0 text-dark">
                                I agree to the{" "}
                                <a href="#" className="text-decoration-underline text-primary">Terms of Service</a> &{" "}
                                <a href="#" className="text-decoration-underline text-primary">Privacy Policy</a>
                              </label>
                            </div>
                          </div>
                          ...
                          <div className="text-center">
                            <h6 className="fw-normal fs-14 mt-4 text-dark mb-0">
                              Already have an account? <a href="/login" className="hover-a">Login</a>
                            </h6>
                          </div>
                        </div>
                      </div>
